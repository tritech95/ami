...
<div class="jumbotron jumbotron-fluid">
    ...
    <div class="container">
        ...
        <p>Lets checkout what makes you feel sick in three steps :) </p>
        <p>We care for you!</p>
    </div>
...
<div class="container-fluid" >
    <div class="row">
        <div class="card" style="min-width: 25%;max-width: 25%;">
            <h4 class="card-header"> Step 1: Select Symptoms</h4>
...
<!--                    <option selected="selected" >Select</option>-->
        ...
        <div class="card" style="min-width: 25%;max-width: 25%">
            <h4 class="card-header">Step 2: Final Symptoms</h4>
        ...
        <div class="card" style="min-width: 50%;max-width: 50%">
            <h4 class="card-header"> Step 3: Possible Conditions</h4>
